...
The MAS redirect URL will be of this format: `<public_baseurl>/auth/upstream/callback/<provider_id>`. Once the client has been created, take note of the `client_id` and `client_secret` generated by the provider. The required endpoints as shown below in the charm configuration can usually be found at `<issuer_url>/.well-known/openid-configuration` 
