...
To create the client, it's important to first retrieve the MAS redirect URL. First we get the upstream OIDC provider ID (`<provider_id>`) generated by the charm:
```
