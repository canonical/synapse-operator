...
def generate_config_from_template(
    ...
    if ownership is not None:
        log(f"Changin ownership to {ownership} is disabled. Please, do it manually before running the script.")
...
def run_generate_config(environ: Mapping[str, str], ownership: Optional[str]) -> None:
    ...
    if ownership is not None:
        ...
        log(f"Changing ownership to {ownership} is disabled. Please, do it manually before running the script.")
