...
TOX_LINT_ARGS ?=
TOX_UNIT_ARGS ?=
TOX_INTEGRATION_DEFAULT_PROJECT_ARGS ?= --charm-file=./$(CHARM_DYNAMIC_ARTIFACT) --$(OCI_RESOURCE_NAME)=$(ROCK_IMAGE)
TOX_INTEGRATION_PROJECT_ARGS ?= $(TOX_INTEGRATION_DEFAULT_PROJECT_ARGS)
